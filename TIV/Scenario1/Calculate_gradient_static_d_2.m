function [gradient_x, gradient_y]=Calculate_gradient_static_d_2(x,y,A,F,obs1,obs2,C)
...
if q>C
    ...
    Gradient_U2=-6000*((1/C)-(1/q))*(1/(q^2))*D_q; %this part to make it adjust more slowly.
end
