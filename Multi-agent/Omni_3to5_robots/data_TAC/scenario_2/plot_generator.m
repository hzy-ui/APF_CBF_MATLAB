...
plot(out.agent4_x1.time,out.agent4_gamma_h_tracking.signals(1).values  ,'b','LineWidth',1.5); %gamma
hold on
plot(out.agent4_x1.time,out.agent4_gamma_h_tracking.signals(2).values  ,'k','LineWidth',1.5);%h
end
...
legend([D1_2,D1_3,D1_4,D1_5], {label3_1,label3_2,label3_3,label3_4},'FontSize',12,'Interpreter','latex','Location','north','NumColumns',2);
legend('boxoff')
xlabel('Time $(s)$','Interpreter','latex','FontSize',8,'FontName','Times New Roman')
ylim([0 120]);
...
legend([D2_1,D2_3,D2_4,D2_5], {label4_1,label4_2,label4_3,label4_4},'FontSize',12,'Interpreter','latex','Location','north','NumColumns',2);
legend('boxoff')
xlabel('Time $(s)$','Interpreter','latex','FontSize',8,'FontName','Times New Roman')
ylim([0 120]);
set(gcf,'Position',[100 100 500 300])
...
legend([D3_1,D3_2,D3_4,D3_5], {label5_1,label5_2,label5_3,label5_4},'FontSize',12,'Interpreter','latex','Location','north','NumColumns',2);
legend('boxoff')
xlabel('Time $(s)$','Interpreter','latex','FontSize',8,'FontName','Times New Roman')
ylim([0 120]);
set(gcf,'Position',[100 100 500 300])
...
legend([D4_1,D4_2,D4_3,D4_5], {label6_1,label6_2,label6_3,label6_4},'FontSize',12,'Interpreter','latex','Location','north','NumColumns',2);
legend('boxoff')
xlabel('Time $(s)$','Interpreter','latex','FontSize',8,'FontName','Times New Roman')
ylim([0 120]);
set(gcf,'Position',[100 100 500 300])
