function [gradient_x, gradient_y]=Calculate_gradient_dynamic(x,y,A,F,obs1,obs2,C)
...
if q>C
    ...
    Gradient_U2=-1210*((1/C)-(1/q))*(1/(q^2))*D_q; %this part to make it adjust more slowly.
end
